...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println("--------------------");
		System.out.println("Demo bookList");
		System.out.println("--------------------");
		books.forEach(b -> System.out.println(b));
		System.out.println("");
		
		System.out.println("--------------------");
		System.out.println("Alfabetic bookList 1P");
		System.out.println("--------------------");
		...
		System.out.println("------------------------");
		System.out.println("bookList no duplicated 1P");
		System.out.println("------------------------");
		removeDuplicates(books);
		System.out.println("");
		
		System.out.println("----------------------");
		System.out.println("bookList before year 1P");
		System.out.println("----------------------");
	...
	// 1P
	// Maak gebruik van een collectie die boeken altijd sorteert op het veld year.
